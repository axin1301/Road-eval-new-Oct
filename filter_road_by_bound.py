...
def filter_road_by_bound(district,year):
    ...
    for district in district_list:
        for year in year_list:
            ...
            if not os.path.exists('results_pixel_coored_final_shp/'+district+'_'+str(year)+'-GE-18-final-wgs.shp'):
                continue
            ...
            edges = gpd.read_file('results_pixel_coored_final_shp/'+district+'_'+str(year)+'-GE-18-final-wgs.shp')  # 你的edge Shapefile路径
            ...
            edges.to_file('results_pixel_coored_final_shp/'+district+'_'+str(year)+'-GE-18-final-wgs_inbound.shp')
